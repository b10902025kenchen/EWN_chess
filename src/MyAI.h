...
private:
	...
	int f3();
	int hash();
	double F3_1(double alpha, double beta, int depth);
	double G3_1(double alpha, double beta, int depth);
	double star1_F3_1(double alpha, double beta, int depth);
	double star1_G3_1(double alpha, double beta, int depth);
};
